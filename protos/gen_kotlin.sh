...
GENERATED_SOURCES_ROOT="kotlin/build/generated/source/wire"
BUILD_SOURCES_ROOT="kotlin-build/src/main/java"
BUILD_OUTPUT="kotlin-build/build"
TIMED_OUTPUT="kotlin-build/ktout"
...
do
  ...
  TIMED=$(time (./gradlew kotlin-build:assemble > /dev/null) 2>&1)
